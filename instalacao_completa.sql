-- ════════════════════════════════════════════════════════
-- FOKOS EVENTOS v6.7 — Instalação completa do banco
-- Schema base + migrações (letreiros, status, financeiro v2)
-- + usuário admin pessoal
--
-- COMO USAR (XAMPP): abra o phpMyAdmin e importe este arquivo.
-- Ele cria o banco `fokos_eventos` do zero; se já existir, apague antes.
-- Gerado em 2026-07-11 — compatível com o app v6.7.0
-- ════════════════════════════════════════════════════════
...
-- ───────── USUÁRIO PESSOAL (Samuel) ─────────
INSERT INTO usuarios (nome, email, senha, tipo, status) VALUES
('Samuel Mena', 'smena.mena@icloud.com', '$2y$12$KHjHWWtUCMadngnIlZbrDusO5DHJqCppQT9LgibzRbsCGcrxd6ehC', 'admin', 'ativo');
